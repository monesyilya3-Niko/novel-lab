...
> **诚实声明**：本文件所有数字均基于 2026-09-11 实测（git `769610d`），未实测的部分明确标注
...
| gui/ 后端模块 | **14** 个 |
| gui/web/src | **28** 个源文件 |
| API 端点 | **44** 个（阶段一 20 + 阶段二 13 + M5 4 + M1/M4 7） |
| 测试 | **272** 用例全绿 |
| git 提交 | **55** 个（截至 `769610d`） |
...
*文档更新时间：2026-09-11 ｜ 数据基准：git `769610d`，测试 272/OK*
